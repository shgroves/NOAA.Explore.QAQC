...
**Fig.6.** Histogram and probability distribution of Density.  
```{r hist of depth, fig.height = 4, fig.width = 7, echo = FALSE}

# create unique sites
uniquesites <- unique(survey_df[, c("SurveyID", "ObservationDate", "ObservationTime", "SampleID", "Density" )]) 


density_hist <- ggplot(uniquesites, aes(x=Density)) + 
  geom_histogram() +
  geom_density(alpha = 0.2) +
  theme_bw() + xlab("Density (cm3)")

"Summary statistics of density (cm3)"
summary(uniquesites$Density)
...
**Fig. 11.** Histogram and probability distribution of Temperature.  
```{r hist of depth, fig.height = 4, fig.width = 7, echo = FALSE}
...
**Fig. 12.** Histogram and probability distribution of Salinity.  
```{r hist of depth, fig.height = 4, fig.width = 7, echo = FALSE}
...
**Fig. 13.** Histogram and probability distribution of Oxygen.  
```{r hist of depth, fig.height = 4, fig.width = 7, echo = FALSE}
