...
# Set wd
setwd("C:/Users/sarah.groves/Documents/Data/Seatube/SeaTube_10_2021_05_2024/")
...
dive_sites <- dat %>%
  dplyr::select(Dive.Name,
                # Multiple column headings are used for Lat and Lon, select all of them
  ...
  #convert the NAs to zeros and then sum the 2 lat columns and the 2 lon columns
  ...
  # To get a single lat and lon for each dive, I took the mean of all coordinates.
